...
object ItemFactory {
    ...
    internal val items = EnumMap<HollowsEve2021, ItemStack>(HollowsEve2021::class.java)
    ...
    fun init() {
        ...
        items[HollowsEve2021.CANDY_CORN] = ItemBuilder.from(Material.GOLD_NUGGET)
            ...
            .lore(listOf(
                ...
                MiniMessage.builder().placeholderResolver(resolver).build().parse("<yellow>...wonder if it has another use...\" <Chuck>").decoration(
                    TextDecoration.ITALIC, false),
                Component.empty(),
                MiniMessage.get().parse("<white>» <green>Used to make Candy Corn Ingots").decoration(TextDecoration.ITALIC, false),
            ).plus(universalLore))
            .pdc {it.set(namespaces[HollowsEve2021.CANDY_CORN]!!, PersistentDataType.BYTE, 1.toByte())}
            .build()

        items[HollowsEve2021.CANDY_CORN_INGOT] = ItemBuilder.from(Material.GOLD_INGOT)
            ...
            .lore(listOf(
                ...
                MiniMessage.builder().placeholderResolver(resolver).build().parse("<yellow>Maybe you could make something?\" <Gigi>").decoration(
                    TextDecoration.ITALIC, false),
                Component.empty(),
        ...
        items[HollowsEve2021.CANDY_CORN_HELMET] = ItemBuilder.from(Material.GOLDEN_HELMET)
        ...
        items[HollowsEve2021.CANDY_CORN_CHESTPLATE] = ItemBuilder.from(Material.GOLDEN_CHESTPLATE)
        ...
        items[HollowsEve2021.CANDY_CORN_PANTS] = ItemBuilder.from(Material.GOLDEN_LEGGINGS)
        ...
        items[HollowsEve2021.CANDY_CORN_BOOTS] = ItemBuilder.from(Material.GOLDEN_BOOTS)
        ...
        items[HollowsEve2021.ONCE_PREY_BOOTS] = ItemBuilder.from(Material.NETHERITE_BOOTS)
        ...
        items[HollowsEve2021.UMBERWOOD_SHARDTHROWER] = ItemBuilder.from(Material.CROSSBOW)
            .name(gradient("Umberwood Shardthrower"))
            .enchant(EcoEnchants.BUCKSHOT, 3)
            .enchant(Enchantment.PIERCING, 4)
            .enchant(Enchantment.DURABILITY, 5)
        ...
        items[HollowsEve2021.GNELL] = ItemBuilder.from(Material.NETHERITE_HOE)
            .name(gradient("Gnell"))
            .enchant(EcoEnchants.CLEAVE, 3)
            .enchant(EcoEnchants.LEECHING, 3)
            .enchant(EcoEnchants.NECROTIC, 5)
        ...
        items[HollowsEve2021.HEADSMANS_HATCHET] = ItemBuilder.from(Material.NETHERITE_AXE)
        ...
        items[HollowsEve2021.GRAVE_DIGGER] = ItemBuilder.from(Material.NETHERITE_PICKAXE)
        ...
        items[HollowsEve2021.CANDY_PAIL] = ItemBuilder.from(Material.BUCKET)
            .name(gradient("Candy Pail"))
            .glow()
            .lore(listOf(
                MiniMessage.get().parse("<yellow>\"It's an old tradition to go around in costume,").decoration(
                    TextDecoration.ITALIC, false),
                MiniMessage.builder().placeholderResolver(resolver).build().parse("<yellow>asking for candy. Go on, give it a try\" <Chuck>").decoration(
                    TextDecoration.ITALIC, false),
                Component.empty(),
                MiniMessage.get().parse("<yellow>Right-click on <green><bold>Chuck</bold><yellow>, <yellow><bold>Gigi</bold><yellow>, or <gold><bold>Bug</bold> <yellow>to get candy!").decoration(
                    TextDecoration.ITALIC, false),
            ))
            .build()

        items[HollowsEve2021.GUMMY_FISH] = ItemBuilder.from(Material.TROPICAL_FISH)
            .name(gradient("Gummy Fish"))
            .glow()
            .lore(listOf(
                MiniMessage.get().parse("<yellow>A gummy fish! Come in <gold>orange<yellow>, <red>cherry<yellow>, and <dark_purple>grape").decoration(
                    TextDecoration.ITALIC, false),
                MiniMessage.get().parse("<yellow>Popular among young children and Merlings").decoration(TextDecoration.ITALIC, false),
                Component.empty(),
                MiniMessage.get().parse("<white>» <green>Grants bonus food and speed on consumption").decoration(
                    TextDecoration.ITALIC, false),
            ))
            .build()

        items[HollowsEve2021.CANDIED_BERRIES] = ItemBuilder.from(Material.SWEET_BERRIES)
        ...
        items[HollowsEve2021.BOWL_OF_CHOCOLATES] = ItemBuilder.from(Material.SUSPICIOUS_STEW)
        ...
        items[HollowsEve2021.ONCE_HOLY_SABER] = ItemBuilder.from(Material.NETHERITE_SWORD)
            ...
            .lore(listOf(
                ...
                MiniMessage.builder().placeholderResolver(resolver).build().parse("<yellow>that has come to taint it.").decoration(
                    TextDecoration.ITALIC, false),
            ).plus(universalLore))
            .build()
        ...
        hat.itemMeta = meta
        items[HollowsEve2021.HOLLOWS_EVE_HAT] = hat
        ...
        hat.itemMeta = meta
        items[HollowsEve2021.STRIDER_MAN_MASK] = hat
        ...
        hat.itemMeta = meta
        items[HollowsEve2021.CLOWN_MASK] = hat
        ...
        hat.itemMeta = meta
        items[HollowsEve2021.SCARECROW_MASK] = hat
        ...
        hat.itemMeta = meta
        items[HollowsEve2021.UNDEAD_MASK] = hat

        items[HollowsEve2021.CANDY_SWORD] = ItemBuilder.from(Material.DIAMOND_SWORD)
            .name(gradient("Candy Sword"))
            .enchant(Enchantment.DAMAGE_ALL, 6)
            .enchant(EcoEnchants.ILLUSION_ASPECT, 3)
            .enchant(Enchantment.DURABILITY, 5)
            .enchant(Enchantment.MENDING)
            .lore(listOf(
        ...
        items.entries.forEach {
            it.setValue(
                ...
                .pdc { pdc ->
                    val value = if(it.key == HollowsEve2021.CANDY_CORN_HELMET || it.key == HollowsEve2021.CANDY_CORN_CHESTPLATE || it.key == HollowsEve2021.CANDY_CORN_PANTS || it.key == HollowsEve2021.CANDY_CORN_BOOTS) {
